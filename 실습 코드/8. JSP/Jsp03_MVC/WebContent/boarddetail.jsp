...
<%
	MVCBoardDto dto = (MVCBoardDto)request.getAttribute("dtoList");
%>
		...
		<table border="1">
			...
			<tr>
				<td colspan="2">
					...
					onclick="location.href='mycontroller.jsp?command=deletelist&seq=<%=dto.getSeq()%>'">
